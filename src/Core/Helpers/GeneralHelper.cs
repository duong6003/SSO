...
namespace Infrastructure.App.Helpers
{
    public static class GeneralHelper
    {
        ...
        public static async Task<(string responseData, int responseStatusCode)> SendRequestAsync(this HttpRequestMessage httpRequestMessage, string endpointURL, IDictionary<string, object>? headers)
        {
            ...
            try
            {
                ...
                {
                    return (string.Empty, responseStatusCode);
                }
                else
                {
        ...
        public static async Task<(string responseData, int responseStatusCode)> SendRequestWithStringContent(this HttpMethod method, string endpointURL, string? encodingData = null, IDictionary<string, object>? headers = null, string mediaType = "application/json")
        {
        ...
        public static async Task<(string responseData, int responseStatusCode)> SendRequestWithFormDataContent(this HttpMethod method, string endpointURL, MultipartFormDataContent? multipartFormData = null, IDictionary<string, object>? headers = null)
        {
            HttpRequestMessage httpRequestMessage = new HttpRequestMessage(method, endpointURL);
