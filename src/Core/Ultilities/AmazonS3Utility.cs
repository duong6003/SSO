...
namespace Core.Utilities
{
    public interface IAmazonS3Utility
    {
        ...
        Task<(bool result, string? errorMessage)> DeleteMultipleResourceAsync(string bucketName, IEnumerable<string> fileNames);
    ...
    public class AmazonS3Utility : IAmazonS3Utility
    {
        ...
        public async Task<(bool result, string? errorMessage)> DeleteMultipleResourceAsync(string bucketName, IEnumerable<string> filePath)
        {
            try
            {
        ...
        private async Task<List<KeyVersion>> PutObjectsAsync(string? bucketName, IEnumerable<string> keys)
        {
